...
impl<'a> PostscriptInterpreter<'a> {
    ...
    fn define_font(&mut self) -> PdfResult<()> {
        ...
        // let encoding = dict
        //     .get(&PostScriptString::from_bytes(b"Encoding".to_vec()))
        //     .unwrap();

        // dbg!(self.get_arr_mut(match encoding {
        //     PostScriptObject::Array(arr) => *arr,
        //     _ => todo!(),
        // }));
        ...
        //         match self
        //             .get_dict(&font)
        //             .get(&PostScriptString::from_bytes(b"FontInfo".to_vec()))
        //             .unwrap()
        //         {
    ...
    fn put(&mut self) -> PdfResult<()> {
        ...
        match composite_obj {
            ...
            _ => {
                // dbg!(&self.operand_stack);
                return Err(PostScriptError::TypeCheck.into());
            }
        }
