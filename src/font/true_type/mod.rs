...
/// dictionary, with these differences:
...
///     lfFaceName field in a LOGFONT structure; in the Mac OS, it shall be based
///     on the name of the FOND resource. If the name contains any SPACEs, the
///     SPACEs shall be removed.
#[derive(Debug)]
